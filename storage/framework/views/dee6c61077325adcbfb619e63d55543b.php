                    ...
                    <div class="collapse" id="sidebarAuthentication">
                         <ul class="nav sub-navbar-nav">
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="<?php echo e(route ('second' , ['auth','signin'])); ?>">Entrar</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="<?php echo e(route ('second' , ['auth','signup'])); ?>">Cadastrar</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="<?php echo e(route ('second' , ['auth','password'])); ?>">Redefinir Senha</a>
                              </li>
                              <li class="sub-nav-item">
                                   <a class="sub-nav-link" href="<?php echo e(route ('second' , ['auth','lock-screen'])); ?>">Tela de Bloqueio</a>
                              </li>
                         </ul>
                    </div>
               </li>
...
<?php /**PATH C:\Users\leopa\Taplox-Laravel_v1.0\Taplox-Laravel\resources\views/layouts/partials/sidebar.blade.php ENDPATH**/ ?>